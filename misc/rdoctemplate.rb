...
/* ========= Added Styles ============*/
div#fileHeader{ background: #00AA00; }
div#classHeader{ background: #008800; }

.method-detail{ background: #DDFFDD; }
.method-heading{ background: #00FF00; }

div.method-source-code{ background: #333333; }
.ruby-comment{ color: #00EE00; }
.ruby-identifier { color: #ffffff; background: transparent; }
__EOS__
...
SRC_PAGE = XHTML_PREAMBLE + <<__EOS__
<html>
<head>
  <title>%title%</title>
  <meta http-equiv="Content-Type" content="text/html; charset=%charset%" />
...
FR_INDEX_BODY = <<__EOS__
!INCLUDE!
__EOS__

FILE_INDEX = XHTML_PREAMBLE + <<__EOS__
<!--
...
START:entries
    <a href="%href%" title="%name%">%name%</a><br />
END:entries
  </div>
</div>
</body>
